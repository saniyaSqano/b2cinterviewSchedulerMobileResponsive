...
const Level3CongratulationsScreen: React.FC<Level3CongratulationsScreenProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50 relative overflow-hidden">
      ...
      <div className="absolute top-16 left-8 w-24 h-24 bg-gradient-to-br from-blue-400/30 to-indigo-400/30 rounded-full blur-xl"></div>
      <div className="absolute bottom-16 right-8 w-32 h-32 bg-gradient-to-br from-indigo-400/30 to-violet-400/30 rounded-full blur-xl"></div>
      <div className="absolute top-1/3 left-1/3 w-20 h-20 bg-gradient-to-br from-blue-300/30 to-indigo-300/30 rounded-full blur-xl"></div>
      
      <div className="relative z-10 h-screen flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-br from-blue-50/80 via-indigo-50/80 to-violet-50/80 backdrop-blur-md border-b border-white/20 p-4">
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/50 p-8 md:p-12 text-center">
              ...
              <div className="flex justify-center mb-6">
                <div className="relative">
                  <div className="w-24 h-24 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full flex items-center justify-center shadow-lg animate-pulse">
                  ...
                  <div className="absolute -bottom-2 -left-2 w-4 h-4 bg-gradient-to-br from-indigo-400 to-violet-500 rounded-full flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div className="bg-gradient-to-br from-blue-100 to-indigo-100 p-4 rounded-xl">
                  <Video className="w-6 h-6 text-blue-600 mb-2 mx-auto" />
                  <p className="text-sm font-semibold text-blue-800">Live Video Feed</p>
                  <p className="text-xs text-blue-700">Practice with real-time feedback</p>
                </div>
                <div className="bg-gradient-to-br from-indigo-100 to-violet-100 p-4 rounded-xl">
                  <Heart className="w-6 h-6 text-indigo-600 mb-2 mx-auto" />
                  <p className="text-sm font-semibold text-indigo-800">Motivational Questions</p>
                  <p className="text-xs text-indigo-700">Discover your strengths</p>
                </div>
              </div>
              ...
              <Button
                onClick={onProceed}
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-4 text-lg font-semibold rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
