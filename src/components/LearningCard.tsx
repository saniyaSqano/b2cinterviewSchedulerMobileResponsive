...
const LearningCard: React.FC<LearningCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`
        relative p-4 rounded-lg border transition-all duration-300 cursor-pointer group bg-white
        ${isActive 
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-slate-600 leading-relaxed text-xs line-clamp-3">{description}</p>
      </div>
